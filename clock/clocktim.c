...
/*
	...
	send:http://ws.trackmytime.com/uattend-1.0.cfc?method=break_pin_punch&key=AJ5P8EG3M2Z3&serial=BN4000-20082123
&pin=5555
...
int Break_Pin_Punch(char *key,char *serial,char *pin)
{
		char send[1024]={0};
		 char address[]="http://ws.trackmytime.com/uattend-1.0.cfc?";
		 sprintf(send,"%smethod=Break_Pin_Punch&key=%s&serial=%s&pin=%s",address,key,serial,pin);
...
/*
	api34:
	send:http://ws.trackmytime.com/uattend-1.0.cfc?method=break_bio_punch&key=AJ5P8EG3M2Z3&serial=BN4000-71661532&fid=00
0001
	recive:
	<?xml version=”1.0” encoding=”UTF-8” ?>
	<result>
...
int Break_Bio_Punch(char *key,char *serial,char *fid)
{
		char send[1024]={0};
		char address[]="http://ws.trackmytime.com/uattend-1.0.cfc?";
		sprintf(send,"%smethod=Break_Bio_Punch&key=%s&serial=%s&fid=%s",address,key,serial,fid);
